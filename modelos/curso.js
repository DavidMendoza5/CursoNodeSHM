...
var CursoSchema = new Schema({
        ...
        docente: {
            ...
            ref: 'docentes',
            required: true
        }, //ref hace referencia al modelo de docentes, al cual nombramos docentes cuando lo exportamos
        fecha_inicio: Date,
        fecha_final: Date,
        status: {
            type: Number,
            enum: [1, 2, 3, 4, 5]
        }, // El enum hace que sólo se acepte lo que se encuentra en el array, si se pone otro valor marca un error
        hora: {
            type: String,
            required: true
        },
