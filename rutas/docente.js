...
api.post('/crearDocente', auth.auth_decode, ControladorDocente.crearDocente);
...
api.delete('/eliminarDocente/:id', auth.auth_decode, ControladorDocente.eliminarDocente);
